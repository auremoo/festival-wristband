// SVG icon components — lightweight, stroke-based (Lucide style, 24x24 viewBox).
...
export function CloudSunIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 2v2M4.22 4.22l1.42 1.42M2 12h2M4.22 19.78l1.42-1.42" />
      <circle cx="12" cy="10" r="4" />
      <path d="M17 18a4 4 0 0 0 0-8 5.5 5.5 0 0 0-10.9 1.2A4 4 0 0 0 8 18h9z" />
    </Icon>
  )
}
...
export function LanguagesIcon(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M5 8h9M9 4v4M12 8a10 10 0 0 1-7 9" />
      <path d="M7 12a7 7 0 0 0 6 4" />
      <path d="m14 20 4-9 4 9M15.5 17h5" />
    </Icon>
  )
}
